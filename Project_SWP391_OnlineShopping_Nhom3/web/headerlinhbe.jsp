                ...
                <div class="container">
                    <div class="row">
                        ...
                        <ul class="nav navbar-nav pull-right"      >
                            ...
                            <li class="nav-item"><a href="${pageContext.request.contextPath}/Cart"><i class="fa fa-shopping-cart"></i> Cart</a></li>
                                        <% if (us != null) {%>
                            <%}%>
                           
                            <li class="nav-link" >
                                <a>Welcome <%=us.getUsername()%></a>
                            </li>
                            <li class="nav-item">
                                <a href="${pageContext.request.contextPath}/AccountInfo" class="nav-link" href="#">Account</a>
                            </li>
                            <li class="nav-item">
                                <a href="${pageContext.request.contextPath}/Bye" class="nav-link" href="#">Logout</a>
                            </li>
